...
class CSteamInterface004 : public ISteamInterface004
{
public:
	CSteamInterface004();
	virtual ~CSteamInterface004();
	...
	virtual int MountFilesystem(unsigned int uAppId, const char *szMountPath, TSteamError *pError);
	...
	virtual int IsSecureComputer(int *pbIsSecure, TSteamError *pError){return 1;}
	...
	virtual int EnumerateAppDependency(unsigned int AppId, unsigned int uDependency, TSteamAppDependencyInfo *pDependencyInfo, TSteamError *pError);
